...
func Focus(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
	itemDAO.MarkAsFocus(id)
...
func Unfocused(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
	itemDAO.MarkAsUnfocused(id)
...
func Postpone(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
	itemDAO.Postpone(id)
